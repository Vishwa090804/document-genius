...
export default function FileUpload({ onFileSelected, file, onClear }) {
    ...
    return (
        <div
            ...
            onDrop={handleDrop}
            className={`relative flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed p-10 transition-all cursor-pointer ${isDragging
